...
TABLA_SONIDOS:
	defw      SONIDO1,SONIDO2,SONIDO3,SONIDO4,SONIDO5;,SONIDO6,SONIDO7;,SONIDO8
...
TABLA_SONG:
	defw      BUFFER_UNCOMP;SONG_0;,SONG_1,SONG_2;,SONG_3          ;******** TABLA DE DIRECCIONES DE ARCHIVOS MUS
TABLA_SONG_CMP:
	defw	_SONG_0,_SONG_1,_SONG_2,_SONG_3,_SONG_4,_SONG_5,_SONG_6,_SONG_7,_SONG_8,_SONG_9,_SONG_10,_SONG_11,_SONG_12,_SONG_13,_SONG_14;,SONG_15

;DATOS_NOTAS:    .INCBIN "C:/EM/BRMSX/PLAYER/NOTAS.DAT"        ;DATOS DE LAS NOTAS


DATOS_NOTAS:    defw $0000,$0000
;		;defw $077C,$0708
;		defw $06B0,$0640,$05EC,$0594,$0544,$04F8,$04B0,$0470,$042C,$03FD
...
;		dw $001A,$0018,$0017,$0016,$0014,$0013,$0012,$0011,$0010,$000F,$000E,$000D
		...
		defw	$688,$62A,$5D2,$57E,$52F,$4E5,$49E,$45C,$41D,$3E2,$3AA,$376
		defw	$344,$315,$2E9,$2BF,$297,$272,$24F,$22E,$20E,$1F1,$1D5,$1BB
...
PUBLIC _SONG_0
_SONG_0:
	BINARY "parasol.mus.bin" 		; Main menu

PUBLIC _SONG_1
_SONG_1:
	BINARY "genesis_gangway.mus.bin"	; Game over

PUBLIC _SONG_2
_SONG_2:
	BINARY "genesis_fin.mus.bin"		; Happy end

PUBLIC _SONG_3
_SONG_3:
	BINARY "Genesis_warrior.mus.bin"	; Happy end for losers without inertia

PUBLIC _SONG_4
_SONG_4:
	BINARY "genesis_jeff2.mus.bin"		; Level 1

PUBLIC _SONG_5
_SONG_5:
	BINARY "genesis_line.mus.bin"		; Level 2

PUBLIC _SONG_6
_SONG_6:
	BINARY "genesis_compote.mus.bin"	; Level 3

PUBLIC _SONG_7
_SONG_7:
	BINARY "genesis_alice.mus.bin"		; Level 4

PUBLIC _SONG_8
_SONG_8:
	BINARY "genesis_homage.mus.bin"		; Level 5

PUBLIC _SONG_9
_SONG_9:
	BINARY "Genesis_equinox_v2.mus.bin"	; Level 6

PUBLIC _SONG_10
_SONG_10:
	BINARY "genesis_jeff2.mus.bin"		; Level 7

PUBLIC _SONG_11
_SONG_11:
	BINARY "genesis_microint.mus.bin"	; Final boss level 1 and 5

PUBLIC _SONG_12
_SONG_12: 
	BINARY "genesis_words.mus.bin"		; Final boss level 2 and 6

PUBLIC _SONG_13
_SONG_13: 
	BINARY "genesis_town.mus.bin"		; Final boss level 3 and 7

PUBLIC _SONG_14
_SONG_14:
	BINARY "genesis_hoc.mus.bin"		; Final boss level 4
...
TEMPO:          defb     00               ;defb TEMPO
TTEMPO:         defb     00               ;defb CONTADOR TEMPO
PUNTERO_A:      defw     00               ;defw PUNTERO DEL CANAL A
PUNTERO_B:      defw     00               ;defw PUNTERO DEL CANAL B
PUNTERO_C:      defw     00               ;defw PUNTERO DEL CANAL C

CANAL_A:        defw     BUFFER_DEC       ;defw DIRECION DE INICIO DE LA MUSICA A
CANAL_B:
	defw     BUFFER_DEC+$10   ;defw DIRECION DE INICIO DE LA MUSICA B
CANAL_C:
	defw     BUFFER_DEC+$20  ;defw DIRECION DE INICIO DE LA MUSICA C

PUNTERO_P_A:
	defw     00               ;defw PUNTERO PAUTA CANAL A
PUNTERO_P_B:
	defw     00               ;defw PUNTERO PAUTA CANAL B
PUNTERO_P_C:
	defw     00               ;defw PUNTERO PAUTA CANAL C

PUNTERO_P_A0:
	defw     00               ;defw INI PUNTERO PAUTA CANAL A
PUNTERO_P_B0:
	defw     00               ;defw INI PUNTERO PAUTA CANAL B
PUNTERO_P_C0:
	defw     00               ;defw INI PUNTERO PAUTA CANAL C


PUNTERO_P_DECA:
	defw     00		;defw PUNTERO DE INICIO DEL DECODER CANAL A
PUNTERO_P_DECB:
	defw     00		;defw PUNTERO DE INICIO DEL DECODER CANAL B
PUNTERO_P_DECC:
	defw     00		;defw PUNTERO DE INICIO DEL DECODER CANAL C

PUNTERO_DECA:
	defw     00		;defw PUNTERO DECODER CANAL A
PUNTERO_DECB:
	defw     00		;defw PUNTERO DECODER CANAL B
PUNTERO_DECC:
	defw     00		;defw PUNTERO DECODER CANAL C       


;CANAL DE EFECTOS - ENMASCARA OTRO CANAL

PUNTERO_P:
	defw     00           	;defw PUNTERO DEL CANAL EFECTOS
CANAL_P:
	defw     BUFFER_DEC+$30 	;defw DIRECION DE INICIO DE LOS EFECTOS
PUNTERO_P_DECP:
	defw     00		;defw PUNTERO DE INICIO DEL DECODER CANAL P
PUNTERO_DECP:
	defw     00	;defw PUNTERO DECODER CANAL P

PSG_REG:
	defb      00,00,00,00,00,00,00,10111000B,00,00,00,00,00,00,00    ;defb (11) BUFFER DE REGISTROS DEL PSG
PSG_REG_SEC:
	defb      00,00,00,00,00,00,00,10111000B,00,00,00,00,00,00,00    ;defb (11) BUFFER SECUNDARIO DE REGISTROS DEL PSG



;ENVOLVENTE_A    EQU     $D033           ;defb
;ENVOLVENTE_B    EQU     $D034           ;defb
;ENVOLVENTE_C    EQU     $D035           ;defb
...
BUFFER_UNCOMP:
	defs	5410		; Space for the largest MUS file

BUFFER_DEC:
	defs      $40		;************************* mucha atencion!!!!
