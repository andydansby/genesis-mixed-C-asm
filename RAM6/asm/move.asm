;;ATTENTION - Believe this is meant for another RAM BANK
...
PUBLIC _move_pingpong_final4
; ping-pong movement for final enemy 4
; param1: 0 (move left), 1 (move right)
; param2: speed
_move_pingpong_final4:
; Entry: HL is the struct Enemy
	ld d, h
	ld e, l			; save e in DE
	ld bc, 6
